'''
    Todo Estado deve possuir uma Constituição
        Limitação ao poder autoritário.
        ...
        Francês
            Movimentos Constitucionais
                Teoria (Ideologia)
                    ...
                    Indispensável à garantia dos direitos
                    Estruturação da organização Político-social

    **representa uma técnica específica de limitação do poder
        com fins garantísticos.
    **Tal qual a teoria da democracia ou do liberalismo
